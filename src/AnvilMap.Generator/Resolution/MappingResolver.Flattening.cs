...
// than one valid split) are surfaced as AM010 and left unmapped rather than guessing - same
...
internal static partial class MappingResolver
{
    ...
    // caller reports AM010 for that case instead of falling through to AM001.
    ...
    // possible path. Returns null with a specific `failureReason` (surfaced as AM021) the moment
