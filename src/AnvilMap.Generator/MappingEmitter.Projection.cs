...
internal static partial class MappingEmitter
{
        ...
        System.Action<Diagnostic>? report)
    {
        ...
        if (body is null)
        {
            ...
            // mapping was dropped from byPair (AM018, already reported by
            // MappingEmitter.ReportOrphanedNestedMappings) hits the exact same code path below.
            // Only report AM002 when this mapping has no such already-explained reason.
        ...
        System.Action<Diagnostic>? report)
    {
        ...
        // guaranteed unconditioned, so none of them can hit the AM005 branch below.
        ...
        foreach (var property in mapping.Properties)
        {
            ...
            // dropped from the initializer entirely (AM005) - the column is never selected.
