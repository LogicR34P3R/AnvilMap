...
public sealed class MappingSourceGenerator : IIncrementalGenerator
{
    ...
    // "GeneratedMappings" - covers `GeneratedMappings.Map<,>`, `AnvilMap.GeneratedMappings.Map<,>`,
    // and `global::AnvilMap.GeneratedMappings.Map<,>`. An unqualified call via
    // `using static AnvilMap.GeneratedMappings;` is a known, accepted gap (falls back to the
