...
/// directly (e.g. <c>services.AddSingleton&lt;IMapper, GeneratedMapperService&gt;()</c>).
/// The generator emits <c>GeneratedMapperService</c>, which implements this interface by
...
public interface IMapper
{
    ...
    /// construction (see diagnostic GM008) - calling this overload for such a
