...
// AM001 (destination property with no matching source) - offers to add [MapIgnore] directly
...
{
    private const string DiagnosticId = "AM001";
    ...
    private static async Task<Document> AddMapIgnoreAsync(Document document, PropertyDeclarationSyntax property, CancellationToken ct)
    {
        ...
        var attribute = SyntaxFactory.Attribute(SyntaxFactory.ParseName("global::AnvilMap.MapIgnoreAttribute"));
