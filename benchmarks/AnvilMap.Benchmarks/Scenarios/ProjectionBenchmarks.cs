...
// samples/AnvilMap.Sample - only the timing question lives here.
// Translation-correctness (generated SQL shape, client-eval fallback) is a regular test
// in AnvilMap.Benchmarks.ParityTests/ProjectionTranslationTests.cs, not a
...
public class ProjectionBenchmarks
{
    ...
    [Benchmark(Baseline = true, Description = "AnvilMap (ProjectToGraphBlogDto)")]
    public List<GraphBlogDto> AnvilMap_ProjectTo()
    {
