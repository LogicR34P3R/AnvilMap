...
public sealed class ProjectionTranslationTests
{
    ...
    [Fact]
    public void Conditional_GeneratedMapperProjection_OmitsConditionalColumnFromSql()
    {
        var (connection, options) = CreateDatabase();
        using var connectionScope = connection;
        ...
        // GM005: a [MapCondition] property is left out of the projection entirely, so the
