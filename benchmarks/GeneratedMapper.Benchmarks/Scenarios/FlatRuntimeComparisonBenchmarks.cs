...
// Both mappers' throughput across the TFMs GeneratedMapper's own capability detection branches on,
...
public class FlatRuntimeComparisonBenchmarks
{
    ...
    private GeneratedMapper.IMapper _generatedIMapper = null!;
    ...
    public void Setup()
    {
        ...
        _generatedIMapper = new GeneratedMapperService();
    }
    ...
    [Benchmark(Description = "GeneratedMapper (dispatcher, closed generic)")]
    ...
    [Benchmark(Description = "GeneratedMapper (dispatcher, closed generic, two-arg)")]
    ...
    [Benchmark(Description = "GeneratedMapper (IMapper, closed generic)")]
    ...
    [Benchmark(Description = "GeneratedMapper (IMapper, closed generic, two-arg)")]
