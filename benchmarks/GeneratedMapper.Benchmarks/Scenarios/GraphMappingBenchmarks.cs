...
public class GraphMappingBenchmarks
{
    ...
    public GraphBlogDto GeneratedMapper_Extension() => _source.ToGraphBlogDto();

    [Benchmark(Description = "GeneratedMapper (dispatcher)")]
    public GraphBlogDto GeneratedMapper_Dispatcher() => GeneratedMappings.Map<GraphBlogDto>(_source);
