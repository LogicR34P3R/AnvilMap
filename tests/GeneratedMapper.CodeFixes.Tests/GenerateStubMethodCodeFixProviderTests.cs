...
";
    ...
    [Fact]
    public async Task GM004_MapFrom_InsertsStubOnTheDestinationType_WithSourceTypeAsParameter()
    {
        var solution = await CodeFixTestHelper.ApplyFixAsync(
            new GenerateStubMethodCodeFixProvider(), "GM004", MapFromConditionSourceFile, MapFromConditionDtoFile);
