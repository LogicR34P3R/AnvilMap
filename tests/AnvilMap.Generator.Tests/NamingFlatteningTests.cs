...
");
    ...
    [Fact]
    public void ExplicitMapPropertyOverride_PlainNameNotSubjectToPascalCaseSearch_ReportsAM021()
    {
        ...
        // search (that's the default name-matching path's fallback only). Reported as AM021
        // (naming exactly what was looked up), not the generic AM001.
        var result = GeneratorTestHelper.Run(@"
using AnvilMap;
...
");
        ...
        Assert.Contains(result.GeneratorDiagnostics, d =>
            d.Id == "AM021" && d.GetMessage().Contains("HomeAddressCity") && d.GetMessage().Contains("NotARealProperty"));
        Assert.DoesNotContain(result.GeneratorDiagnostics, d => d.Id == "AM001");
    ...
    public void ExplicitMapPropertyOverride_DottedPath_ResolvesNestedProperty()
    {
        ...
        // automatic PascalCase search refuses to guess (AM010) - but an explicit [MapProperty]
...
");
    ...
    [Fact]
    public void ExplicitMapPropertyOverride_DottedPath_UnknownIntermediateSegment_ReportsAM021WithSpecificSegment()
    {
        var result = GeneratorTestHelper.Run(@"
using AnvilMap;
...
");
        ...
        Assert.NotNull(result.GeneratedSource);
        Assert.Contains(result.GeneratorDiagnostics, d =>
            d.Id == "AM021" && d.GetMessage().Contains("Address") && d.GetMessage().Contains("Cty"));
        Assert.DoesNotContain("HomeAddressCity", result.GeneratedSource);
    }

    [Fact]
    public void ExplicitMapPropertyOverride_DottedPath_NullableIntermediateSegment_ReportsAM021()
    {
        var result = GeneratorTestHelper.Run(@"
using AnvilMap;
...
");
        ...
        Assert.NotNull(result.GeneratedSource);
        Assert.Contains(result.GeneratorDiagnostics, d =>
            d.Id == "AM021" && d.GetMessage().Contains("HomeAddress") && d.GetMessage().Contains("nullable"));
        Assert.DoesNotContain("HomeAddressCity", result.GeneratedSource);
    }
...
");
        ...
        Assert.Contains(result.GeneratorDiagnostics, d => d.Id == "AM001" && d.GetMessage().Contains("HomeAddressCity"));
    }

    [Fact]
    public void AmbiguousFlattenedMatch_ReportsAM010AndLeavesPropertyUnmapped()
    {
...
");
    ...
    [Fact]
    public void NoPossibleSplit_StillReportsAM001()
    {
        var result = GeneratorTestHelper.Run(@"
using AnvilMap;
...
");
        ...
        Assert.Contains(result.GeneratorDiagnostics, d => d.Id == "AM001" && d.GetMessage().Contains("CompletelyUnrelatedName"));
    }
...
");
    ...
    [Fact]
    public void IncompatibleLeafType_ReportsAM003WithTheFlattenedPathInTheMessage()
    {
...
");
    ...
    public void ExplicitMapPropertyOverride_DottedPath_NotAutoReversedByGenerateReverse()
    {
        ...
        // left unmapped there (AM001), same fail-open-to-AM001 outcome as automatic flattening.
        var result = GeneratorTestHelper.Run(@"
using AnvilMap;
...
");
    ...
    [Fact]
    public void ExplicitMapPropertyOverride_DottedPath_UnknownFirstSegment_ReportsAM021()
    {
        var result = GeneratorTestHelper.Run(@"
using AnvilMap;
...
");
        ...
        Assert.NotNull(result.GeneratedSource);
        Assert.Contains(result.GeneratorDiagnostics, d =>
            d.Id == "AM021" && d.GetMessage().Contains("Sample.User") && d.GetMessage().Contains("NotReal"));
        Assert.DoesNotContain("HomeAddressCity", result.GeneratedSource);
    }

    [Fact]
    public void ExplicitMapPropertyOverride_DottedPath_UnknownLeafSegment_ReportsAM021()
    {
...
");
        ...
        Assert.NotNull(result.GeneratedSource);
        Assert.Contains(result.GeneratorDiagnostics, d =>
            d.Id == "AM021" && d.GetMessage().Contains("Sample.Address") && d.GetMessage().Contains("NotReal"));
        Assert.DoesNotContain("HomeAddressCity", result.GeneratedSource);
    }

    [Fact]
    public void ExplicitMapPropertyOverride_DottedPath_TrailingDot_ReportsAM021WithoutCrashing()
    {
        var result = GeneratorTestHelper.Run(@"
using AnvilMap;
...
");
        ...
        Assert.NotNull(result.GeneratedSource);
        Assert.Contains(result.GeneratorDiagnostics, d => d.Id == "AM021");
        Assert.DoesNotContain("HomeAddressCity", result.GeneratedSource);
    }

    [Fact]
    public void ExplicitMapPropertyOverride_DottedPath_TargetingIgnoredProperty_ReportsAM012NotAM021()
    {
        // [MapIgnore] wins before source resolution is ever attempted (see MappingResolver.cs's
        // deadOverrides check) - a dotted [MapProperty] on an ignored property must report AM012
        // (dead override), not AM021, since its source is never actually looked up.
        var result = GeneratorTestHelper.Run(@"
using AnvilMap;
