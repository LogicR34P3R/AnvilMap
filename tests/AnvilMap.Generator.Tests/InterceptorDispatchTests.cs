...
";
    ...
    {
        // AM008: no two-arg To{Dest}(source, destination) overload exists for an init-only
        ...
        // No _mapInto entry exists for this pair (AM008) - matches DispatcherRuntimeTests'
